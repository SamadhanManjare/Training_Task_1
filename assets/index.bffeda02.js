import{r as l,j as e,cN as T,o as t,cO as y,cP as j,cQ as x,cI as b,cB as I,cR as A,cE as H,cF as U,cS as C,cD as E,cA as N,cj as P,ae as $,af as o,ai as B,ah as u}from"./index.57029c3f.js";import{C as n}from"./index.0386408b.js";import{B as K}from"./index.3fb32e9f.js";import{s as k,a as w}from"./05.826ce009.js";import{c as R}from"./08.f1bba1b6.js";import{K as z}from"./App.a0dd4679.js";const p=[{src:b,id:1},{src:I,id:2},{src:k,id:3}],D=()=>{const[r,c]=l.exports.useState(0),[a,i]=l.exports.useState(0),h=()=>{c(!0)},f=()=>{c(!1)},d=()=>{if(r)return;const s=a===p.length-1?0:a+1;i(s)},m=()=>{if(r)return;const s=a===0?p.length-1:a-1;i(s)},v=s=>{r||i(s)},S=p.map(s=>e(T,{onExiting:h,onExited:f,children:e("img",{src:s.src,className:"img-fluid",alt:s.id})},s.id));return t(y,{activeIndex:a,next:d,previous:m,keyboard:!1,children:[e(j,{items:p,activeIndex:a,onClickHandler:v}),S,e(x,{direction:"prev",directionText:"Previous",onClickHandler:m}),e(x,{direction:"next",directionText:"Next",onClickHandler:d})]})},g=[{src:H,id:1,header:"Slide 1",caption:"Donut jujubes I love topping I love sweet. Jujubes I love brownie gummi bears I love donut sweet chocolate. Tart chocolate marshmallow.Tart carrot cake muffin."},{src:R,id:2,header:"Slide 2",caption:"Tart macaroon marzipan I love souffl\xE9 apple pie wafer. Chocolate bar jelly caramels jujubes chocolate cake gummies. Cupcake cake I love cake danish carrot cake."},{src:U,id:3,header:"Slide 3",caption:"Pudding sweet pie gummies. Chocolate bar sweet tiramisu cheesecake chocolate cotton candy pastry muffin Marshmallow cake powder icing."}],F=()=>{const[r,c]=l.exports.useState(0),[a,i]=l.exports.useState(0),h=()=>{c(!0)},f=()=>{c(!1)},d=()=>{if(r)return;const s=a===g.length-1?0:a+1;i(s)},m=()=>{if(r)return;const s=a===0?g.length-1:a-1;i(s)},v=s=>{r||i(s)},S=g.map(s=>t(T,{onExiting:h,onExited:f,children:[e("img",{src:s.src,className:"img-fluid",alt:s.id}),e(A,{captionText:s.caption,captionHeader:e("span",{className:"text-white",children:s.header})})]},s.id));return t(y,{activeIndex:a,next:d,previous:m,keyboard:!1,interval:5e5,children:[e(j,{items:g,activeIndex:a,onClickHandler:v}),S,e(x,{direction:"prev",directionText:"Previous",onClickHandler:m}),e(x,{direction:"next",directionText:"Next",onClickHandler:d})]})},J=[{key:1,src:b,caption:"",altText:"Slide 1"},{key:2,src:I,caption:"",altText:"Slide 2"},{key:3,src:k,caption:"",altText:"Slide 3"}],M=()=>e(C,{items:J,keyboard:!1}),O=[{src:E,key:1,caption:"",altText:"Slide 1"},{src:N,key:2,caption:"",altText:"Slide 2"},{src:w,key:3,caption:"",altText:"Slide 3"}],Q=()=>e(C,{items:O,interval:"500",keyboard:!1}),Y=[{src:I,key:1,caption:"",altText:"Slide 1"},{src:E,key:2,caption:"",altText:"Slide 2"},{src:k,key:3,caption:"",altText:"Slide 3"}],q=()=>e(C,{items:Y,keyboard:!0}),G=[{src:N,key:1,caption:"",altText:"Slide 1"},{src:I,key:2,caption:"",altText:"Slide 2"},{src:w,key:3,caption:"",altText:"Slide 3"}],L=()=>e(C,{items:G,pause:"hover",keyboard:!1}),V=e("pre",{children:e("code",{className:"language-jsx",children:`
